...
URL = "https://turing.cs.olemiss.edu/~jato/weir232Printer.html"
...
mycursor.execute('DELETE FROM printer3supplies')

sql = "INSERT INTO printer3supplies (cycles) VALUES (%s)"
val = (cyclelist)
...
mycursor.execute('DELETE FROM printer3')

#insert values into db
mycursor.executemany('''INSERT INTO printer3 (number, date, time, cycles, event, firmware, description)
...
URL = "https://turing.cs.olemiss.edu/~jato/weir232InkLevel.html"
page = requests.get(URL)
...
sql = "INSERT INTO printer3supplies (ink) VALUES (%s)"
val = (inky)
mycursor.execute(sql, val)
