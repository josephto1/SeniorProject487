...
URL = "https://turing.cs.olemiss.edu/~jato/event1.html"
...
mycursor.execute('DELETE FROM printer1supplies')

sql = "INSERT INTO printer1supplies (cycles) VALUES (%s)"
val = (cyclelist)
...
mycursor.execute('DELETE FROM printer1')

#insert values into db
mycursor.executemany('''INSERT INTO printer1 (number, date, time, cycles, event, firmware, description)
...
URL = "https://turing.cs.olemiss.edu/~jato/adlerNorthInkLevel.html"
page = requests.get(URL)
...
sql = "INSERT INTO printer1supplies (ink) VALUES (%s)"
val = (inky)
mycursor.execute(sql, val)
